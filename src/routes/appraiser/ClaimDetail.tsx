...
export default function ClaimDetail() {
  ...
  return (
    <div style={{ padding: 16, display: "grid", gap: 12 }}>
      ...
      >
        <h3 style={{ margin: 0 }}>Claim {claim.claim_number}</h3>
      ...
      <div>
        ...
        <input
          type="datetime-local"
          onChange={(e) =>
            update({ appointment_end: new Date(e.target.value).toISOString() })
          }
        />
      </div>
      ...
      <div>
        ...
        >
          <h5 style={{ color: "#dc3545", marginBottom: 8 }}>⚠️ Danger Zone</h5>
          <button
            onClick={deleteClaim}
            style={{
              padding: "8px 16px",
      ...
      <div>
        ...
        >
          ...
          <p
            style={{ fontSize: 13, color: "#666", marginTop: 8, width: "100%" }}
          >
